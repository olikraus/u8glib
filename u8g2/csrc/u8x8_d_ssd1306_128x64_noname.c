...
uint8_t u8x8_d_ssd1306_128x64_noname(u8x8_t *u8g2, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    case U8X8_MSG_DISPLAY_INIT:
      u8x8_d_helper_display_init(u8g2, &u8x8_ssd1306_128x64_noname_display_info);
      u8x8_cad_SendSequence(u8g2, u8x8_d_ssd1306_128x64_noname_init_seq);
    
      break;
    case U8X8_MSG_DISPLAY_SET_POWER_SAVE:
      if ( arg_int == 0 )
	u8x8_cad_SendSequence(u8g2, u8x8_d_ssd1306_128x64_noname_powersave0_seq);
      else
	u8x8_cad_SendSequence(u8g2, u8x8_d_ssd1306_128x64_noname_powersave1_seq);
      break;
#ifdef U8X8_WITH_SET_FLIP_MODE
    case U8X8_MSG_DISPLAY_SET_FLIP_MODE:
      if ( arg_int == 0 )
	u8x8_cad_SendSequence(u8g2, u8x8_d_ssd1306_128x64_noname_flip0_seq);
      else
	u8x8_cad_SendSequence(u8g2, u8x8_d_ssd1306_128x64_noname_flip1_seq);
      break;
#endif
#ifdef U8X8_WITH_SET_CONTRAST
    case U8X8_MSG_DISPLAY_SET_CONTRAST:
      u8x8_cad_StartTransfer(u8g2);
      u8x8_cad_SendCmd(u8g2, 0x081 );
      u8x8_cad_SendArg(u8g2, arg_int );	/* ssd1306 has range from 0 to 255 */
      u8x8_cad_EndTransfer(u8g2);
      break;
#endif
    case U8X8_MSG_DISPLAY_DRAW_TILE:
      ...
      x *= 8;
      x += u8g2->x_offset;
      u8x8_cad_SendCmd(u8g2, 0x010 | (x>>4) );
      u8x8_cad_SendCmd(u8g2, 0x000 | ((x&15)));
      u8x8_cad_SendCmd(u8g2, 0x0b0 | (((u8x8_tile_t *)arg_ptr)->y_pos));
