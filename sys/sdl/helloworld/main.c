...
int main(void)
{
  ...
  do
  {
    ...
    u8g_DrawStr(&u8g, 0, 20, "Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World! Hello World!");
  } while( u8g_NextPage(&u8g) );
